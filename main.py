...
def handle_capturar(ack, body, client): ack(); services.capturar_chamado(client, body)

@app.action("finalizar_chamado")
def handle_finalizar(ack, body, client): ack(); services.finalizar_chamado(client, body)

@app.action("reabrir_chamado")
def handle_reabrir(ack, body, client): ack(); services.abrir_modal_reabertura(client, body)

@app.action("editar_chamado")
def handle_editar(ack, body, client): ack(); services.abrir_modal_edicao(client, body["trigger_id"], body["message"]["ts"])
